...
about = {}
with open(os.path.join(here, "housemartin", "__version__.py"), "r") as f:
    exec(f.read(), about)
...
setup(
    ...
    url="https://github.com/cedadev/housemartin",
    python_requires=REQUIRES_PYTHON,
    classifiers=classifiers,
    license="Apache Software License 2.0",
    keywords="wps pywps birdhouse housemartin",
    ...
    entry_points={
        "console_scripts": [
            "housemartin=housemartin.cli:cli",
        ]
    },
)
