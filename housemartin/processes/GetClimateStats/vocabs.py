...
class Vocabs(object):
    ...
    variable_content = """
tas,Temperature: daily mean,degC
...
zos,Sea Surface Height Above Geoid: monthly,mm
""".strip().split("\n")

    global_models_per_variable_string = """
tas  14      BCC/bcc-csm1-1-m        BNU/BNU-ESM     CCCma/CanESM2   CMCC/CMCC-CMS           CSIRO-BOM/ACCESS1-3     CSIRO-QCCCE/CSIRO-Mk3-6-0       INM/inmcm4      IPSL/IPSL-CM5A-MR               MOHC/HadGEM2-ES MPI-M/MPI-ESM-MR                        NCAR/CCSM4      NCC/NorESM1-M   NOAA-GFDL/GFDL-ESM2M    NSF-DOE-NCAR/CESM1-CAM5
...
""".strip().split("\n")
    ...
    regional_inst_models = ('ICHEC-EC-EARTH/AFR-44', 'ICHEC-EC-EARTH/ARC-44', 
                            'ICHEC-EC-EARTH/EUR-44', 'ICHEC-EC-EARTH/MNA-44', 'ICHEC-EC-EARTH/NAM-44')
