...
# Add housemartin to sys.path to avoid having to full
# install housemartin for autodoc.
# Full install of housemartin will burst memory limit on ReadTheDocs.
...
htmlhelp_basename = "housemartindoc"
